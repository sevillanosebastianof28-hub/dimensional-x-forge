...
const Hero = () => {
  return (
    <main className="flex-grow flex items-center justify-center py-20 px-20 relative z-[1] max-w-[1400px] mx-auto">
      ...
      <div className="bg-black/40 rounded-[20px] py-16 px-20 flex justify-between items-center gap-20 w-full border border-primary shadow-[0_0_25px_rgba(0,255,255,0.5),0_0_50px_rgba(0,255,255,0.2)] relative">
        ...
        <div className="flex-[0_0_50%] max-w-[550px] relative z-[3]">
          ...
          <a 
            href="#" 
            className="inline-block px-9 py-4 text-primary bg-transparent border-2 border-primary font-bold rounded-md transition-all shadow-[0_0_10px_rgba(0,255,255,0.5)] hover:bg-primary hover:text-background hover:shadow-[0_0_25px_rgba(0,255,255,1)] no-underline relative z-[3]"
          >
            Request a Quote
          </a>
        </div>
        ...
        <div className="flex-[0_0_50%] flex justify-center items-center relative min-h-[350px]">
          ...
          <img 
            src="https://i.imgur.com/8Q9jN57.png" 
            alt="Abstract light trails background" 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] opacity-70 z-[1]"
            style={{
