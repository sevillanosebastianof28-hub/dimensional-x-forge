            ...
            <div className="mb-12 animate-fade-in relative">
              <div className="flex items-center gap-6">
                <img 
                  ...
                  className="w-[120px] h-[120px] drop-shadow-[0_0_40px_rgba(0,246,255,0.6)] animate-[spin_8s_linear_infinite]"
                />
                <img 
                  src={logo} 
                  alt="Dimensional X" 
                  className="w-[450px] h-auto drop-shadow-[0_0_40px_rgba(0,246,255,0.6)] hover:drop-shadow-[0_0_60px_rgba(0,246,255,0.9)] transition-all duration-500"
                />
              </div>
            </div>
